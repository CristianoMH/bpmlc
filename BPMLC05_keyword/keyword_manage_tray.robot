...
#-- Maker chọn yêu cầu Phát hành luồng nhanh chưa phát hành nháp
[tray][phnhanh] - Maker choose request
    [BPM] - Wait for element not to appear on page    ${loading_page}    120
    [BPM] - Wait for element to appear on page    ${btn_create}    60
    [BPM] - Click element    ${btn_create}
    sleep    1 
    [BPM] - Click element    ${radioBtn_lc}
    sleep    1
    ...
    [BPM] - Click element    ${btn_dialog_phat_hanh}
    sleep    1
    [BPM] - Click element    ${btn_dialog_phat_hanh_nhanh}
    sleep    1
    [BPM] - Click element    ${radiobtn_dialog_53}
    sleep    1
    [BPM] - Click element    ${btn_dialog_create_2}
    sleep    1

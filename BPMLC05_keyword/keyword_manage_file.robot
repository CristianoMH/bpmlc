...
[phnhap] - Maker upload file
    ...
    Choose file    ${input_upload_ycmttd}   ${CURDIR}${/}file_test${/}test01.docx
    sleep    5
    Wait Until Element Is Visible    ${a_upload_hdi}    20s
    Choose file    ${input_upload_hdi}   ${CURDIR}${/}file_test${/}test02.docx
    sleep    5
    Wait Until Element Is Visible    ${a_upload_mxnnnhtt}    20s
    Choose file    ${input_upload_mxnnnhtt}   ${CURDIR}${/}file_test${/}test03.docx
    sleep    5
...
[phct] - Maker upload file
    ...
    Choose file    ${input_upload_gcnbh}   ${CURDIR}${/}file_test${/}test03.docx
    sleep    5
    Wait Until Element Is Visible    ${a_upload_mxnnnhtt}    20s
    Choose file    ${input_upload_mxnnnhtt}   ${CURDIR}${/}file_test${/}test04.docx
    sleep    5
